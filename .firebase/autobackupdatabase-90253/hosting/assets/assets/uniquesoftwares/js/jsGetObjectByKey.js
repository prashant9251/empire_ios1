...
key = ["BILLREC", "TDS", "JOBWORK", "ATYPE", "CHALTRN", "FINISHSTOCK", "TIME", "TRANSPORT", "HASTE", "CITY", "ITEMWISESALE", "ACGROUP", "MILL", "OUTSTANDING", "LEDGER", "SERIES", "COMPMST", "QUL", "MST", "DET", "BLS",];
keyArrayInDatabase = ["PCORDER", "ACGROUP", "ATYPE", "JOBWORK", "BILLREC", "TDS", "ORDER", "CHALTRN", "FINISHSTOCK", "TIME", "TRANSPORT", "HASTE", "CITY", "ITEMWISESALE", "MILL", "OUTSTANDING", "PURCHASE", "LEDGER", "EMP", "FAS", "BLS", "SERIES", "COMPMST", "QUL", "PACKINGSTYLE", "MST", "DET", "settMill", "settOTG",];
      ...
      if (AppLocalStorage.toString().toUpperCase() != "INDEXDB") {
        getObjectFromLive(Db, key, subKey).then(
          ...
          try {
            ...
            getObjectFromIndexDbWeb(Db, key, subKey).then(
              function (d) {
                resultInJson = d;
                resolve(resultInJson);
              },
