...
function jsLoadCallJOBWORK_PARTYWISE_TRWISE(data) {
  ...
  <th colspan="17" class="trPartyHead">`+ PARTY_NAME + `</th>
    </tr>
    `;
      ...
      <th colspan="17" class="" onclick="openSubRType('`+ PartyWithTypeData.TYPE + `','` + PARTY + `')">` + SERIES_NAME + `</th>
        </tr>
        ...
        for (let m = 0; m < TRANSACTION.length; m++) {
          ...
          tr += ` 
                              ...
                              <td  class="hideBILL">` + getValueNotDefine(element.BLL) + `</td>
                                  ...
                                  <td  class="hideAGHASTE" onclick="openSubR('`+ element.code + `')">` + getValueNotDefine(BrokerHaste) + ` </td>
