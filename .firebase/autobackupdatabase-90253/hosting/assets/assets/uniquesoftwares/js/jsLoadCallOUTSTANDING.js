...
function loadCall(data) {
  ...
  if (DL > 0) {
    ...
    for (var i = 0; i < DL; i++) {
      ...
      sendShareText += "Dear *" + Data[i].code + "*";
      sendShareText += "\n\nYour bill No. \n";
      ...
      if (BLL > 0) {
        ...
        for (j = 0; j < BLL; j++) {
          ...
          if (Data[i].billDetails[j].DT.toUpperCase().indexOf("OS") > -1) {
            sendShareText += `` + getValueNotDefine(Data[i].billDetails[j].BILL) + `   ` + formatDate(Data[i].billDetails[j].DATE) + ` = *` + getValueNotDefine(Data[i].billDetails[j].PAMT) + `/-*\n`;
          }
          ...
          row += ` 
                                ...
                                <td  class="hideBILLNO"><a target="_blank" href="` + FdataUrl + `"><button>` + getValueNotDefine(Data[i].billDetails[j].BILL) + `</button></a></td>
                                ...
                                <td  class="hideTDSTCS" style="display:none;">` + getValueNotDefine(Data[i].billDetails[j].T) + `</td>
                                <td  class="hideL1R" style="display:none;">` + getValueNotDefine(Data[i].billDetails[j].L1R) + `</td>
                                <td  class="hideL1P" style="display:none;">` + getValueNotDefine(Data[i].billDetails[j].L1P) + `%</td>
                                <td  class="hideL2R" style="display:none;">` + getValueNotDefine(Data[i].billDetails[j].L2R) + `</td>
                                <td  class="hideL2P" style="display:none;">` + getValueNotDefine(Data[i].billDetails[j].L2P) + `%</td>
                                <td  class="hideL3R" style="display:none;">` + getValueNotDefine(Data[i].billDetails[j].L3R) + `</td>
                                <td  class="hideL3P" style="display:none;">` + getValueNotDefine(Data[i].billDetails[j].L3P) + `%</td>
                                <td  class="hideRMK" style="display:none;">` + getValueNotDefine(Data[i].billDetails[j].R1) + `</td>
                                <td  class="hideBAL" style="display:none;">`+ valuetoFixed(totalAmount) + `</td>
                                <td  class="hideVNO" style="display:none;">` + getValueNotDefine(Data[i].billDetails[j].VNO) + `</td>
                                </tr>`;
        ...
        row += `<tr class="tfootcard">
                                ...
                                <th  class="hideGROSSAMT">` + valuetoFixed(totalGROSSAMT) + `</th>
                                <th  class="hideGST">`+ valuetoFixed(totalGST) + `</th>
                                <th  class="hideNETBILLAMT">` + valuetoFixed(totalNETBILLAMT) + `</th>
                                <th  class="hideGOODSRET">` + valuetoFixed(totalGOODSRETURN) + `</th>
                                <th  class="hidePAIDAMT">` + valuetoFixed(totalPAIDAMT) + `</th>
                                <th  class="hidePENDAMT">` + valuetoFixed(totalAmount) + `</th>
                                <th   class="hideDAYS">`+ parseInt(avgDays) + `</th>
                                ...
                                <th  class="hideBAL" style="display:none;">`+ valuetoFixed(totalAmount) + `</th>
    ...
    <th  class="hidePAIDAMT">` + valuetoFixed(grandtotalPAIDAMT) + `</th>
    <th  class="hidePENDAMT">` + valuetoFixed(grandtotalAmount) + `</th>
    ...
    <th  class="hideL3P" style="display:none;"></th>
    <th  class="hideRMK" style="display:none;"></th>
    <th  class="hideBAL" style="display:none;">`+ valuetoFixed(grandtotalAmount) + `</th>
    <th  class="hideVNO" style="display:none;"></th>
    </tr>`;
