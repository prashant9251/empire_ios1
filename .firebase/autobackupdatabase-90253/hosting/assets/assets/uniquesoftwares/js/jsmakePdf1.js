...
function loadBillPdfCall() {
    ...
    <div class="table-responsive">
        <div style="width:100%;display:flex;`+iosTransformCss+`"> 
                  <div style="display:inline; text-align: right;float: left;width: 60%;" >
                    <div style=""class="hideShreeGaneshayNamaha font12">
                    !!Shree Ganeshay Namaha!!</div>
                  </div>
                  
                  <div style=" display:inline;text-align: right; float: left;width: 40%;" class="font12">
                Phone:`+ getValueNotDefine(firmArray[0]["MOBILE"]) + `,` + getValueNotDefine(firmArray[0]["PHONE1"]) + `</div>
        </div>
      ...
      <hr class="pdfhr">`;
              ...
              <div style="display:inline;text-align: left; float: left;
              width: 100%;
              "class="font14">Consignee:<b class="hidehaste">` + getValueNotDefine(NEWBLS[x].billDetails.haste) + `</b></div>
              </div>
              <div style="width:100%"> 
                          <div style="display:inline;text-align: left; float: left;
                          width:100%;
                          "class="font14">DELIVERY :<b class="hideDeilvery">` + AD3 + `,` + AD4 + `</b></div>
              </div>
      ...
      <hr class="pdfhr">
            ...
            <div style="width:100%">     
                        ...
                        "class="font14">TRANSPORT:` + getValueNotDefine(NEWBLS[x].billDetails.TRNSP) + `</div>
                          ...
                          <div style=" display:inline;text-align: left; float: left;
                          width: 30%;
                        "class="font14">CASE NO:` + getValueNotDefine(NEWBLS[x].billDetails.CSNO) + ` X ` + getValueNotDefine(NEWBLS[x].billDetails.PRCL) + `</div>
        ...
        <div style="width:100%">     
             ...
             <div style="width:100%">            
                        ...
                        ">Distance(Km):` + getValueNotDefine((NEWBLS[x].billDetails.DST)) + `</div>
                          ...
                          <div class="font12"style=" display:inline;text-align: left; float: left;font-weight: bold;
                          width: 33.33%;
                        ">Transposter ID:`+transportId+`</div>
       ...
       `;
            ...
            if (DET.length > 0) {
              ...
              div += `
                ...
                <thead>
                          <tr style="width:100%;">
                                    <th class="hideQuality">SR. PARTICULARS</th>
              ...
              `;
                ...
                for (var k = 0; k < billDet.length; k++) {
                  ...
                  div += `
        <tr>   
           <td class="hideQuality" >`+ getValueNotDefine(billDet[k].SR_NEW) + `-` + getValueNotDefine(billDet[k].qual) + `</td>
           ...
           `;
                  ...
                  if (billDet[k].DET != undefined && billDet[k].DET != null && billDet[k].DET != "") {
                    div += `
                  <tr>   
                    <td  class="hideCOLORSBOTTOM"colspan="11">` + `-` + getValueNotDefine(billDet[k].DET) + `</td>
                  </tr>
                   `;
                  }
              ...
              <table class="table font12"  style="width: 100%;height: fit-content;;text-align:left;">
                        ...
                        <tr>   
                        <td class="hideQuality" >` + getValueNotDefine(NEWBLS[x].billDetails.QUAL) + `</td>
                        <td class="hidePCS" >`+ getValueNotDefine(NEWBLS[x].billDetails.TPCS) + `</td>
                        <td class="hideMTR" >`+ getValueNotDefine(NEWBLS[x].billDetails.MTS) + `</td>
  ...
  <div>
      <hr class="pdfhr">
            ...
            <div style="width:100%;">          
                      <div style="display:inline;text-align: left; float: left;font-weight:bold;
                      width: 50%;
...
`;
            ...
            if (NEWBLS[x].billDetails.LA1RATE != 0) {
              div += ` 
                <div class="hideAddLess1" style="display:inline;text-align: right; float: left;
              width:92%;
           ...
           `;
            ...
            if (NEWBLS[x].billDetails.LA2RATE != 0) {
              ...
              div += ` 
                  <div class="hideAddLess2" style="display:inline;text-align: right; float: left;
                  width:92%;
           ...
           `;
            ...
            if (NEWBLS[x].billDetails.LA3RATE != 0) {
              ...
              div += `
             <div class="hideAddLess3" style="display:inline;text-align: right; float: left;
              width:92%;
                ...
                if (getValueNotDefineNo(NEWBLS[x].billDetails.VTRET) != 0) {
                  div += `
                      <div style="width:100%">
                            <div style="display:inline;text-align: right; float: left;
                            width:92%;
                            "class="font14">CGST @ `+ getValueNotDefine(NEWBLS[x].billDetails.VTRET) + `% on Taxable Value  ` + grossAmt + ` = ` + getValueNotDefine(valuetoFixed(NEWBLS[x].billDetails.VTAMT)) + `</div>
                  ...
                  <div style="width:100%">
                        <div style="display:inline;text-align: right; float: left;
                        width: 92%;
                        "class="font14">SGST @ `+ getValueNotDefine(NEWBLS[x].billDetails.ADVTRET) + `% on Taxable Value  ` + grossAmt + ` = ` + getValueNotDefine(valuetoFixed(NEWBLS[x].billDetails.ADVTAMT)) + `</div>
            ...
            if (getValueNotDefineNo(NEWBLS[x].billDetails.TDSAMT) != 0) {
             ...
             <div style="display:inline;text-align: right; float: left;
              width:92%;
              "class="font14"> -> `+tdsTcsTitle+` -> ` + getValueNotDefine(NEWBLS[x].billDetails.TDSRATE) + ` : ` + getValueNotDefine(valuetoFixed(NEWBLS[x].billDetails.TDSAMT)) + `</div>
            `;
            }
