...
function loadCall(Data) {
  ...
  if (DL > 0) {
      ...
      if (BLL > 0) {
        ...
        for (j = 0; j < BLL; j++) {
          ...
          if (j == 0 && codex != CodePrev) {
            ...
            <th class="hidePWSPBILLAMT" style="display:none;">BILL AMT</th>
          ...
          if (j != 0 && codex != CodePrev) {
            ...
            <th>` + valuetoFixed(subtotalBAmt) + `</th>
            <th>` + valuetoFixed(subtotalFAmt) + `</th>
            <th colspan="9"></th>
            </tr>  `;
            CodePrev = codex;
            totalGrossAmt += subtotalGrossAmt;
            totalBAmt += subtotalBAmt;
            totalFAmt += subtotalFAmt;
            subtotalGrossAmt = 0;
            subtotalBAmt = 0;
            subtotalFAmt = 0;
          }
          ...
          if (Data[i].billDetails[j].DT != null && Data[i].billDetails[j].DT != "") {
            if (Data[i].billDetails[j].DT.toUpperCase().indexOf('CN')) {
              ...
              BAmt = +Math.abs(Data[i].billDetails[j].BAMT);
              FAmt = +Math.abs(Data[i].billDetails[j].FAMT);
          ...
          subtotalBAmt += parseInt(BAmt);
          subtotalFAmt += parseInt(FAmt);
          ...
          tr += `<tr align="center"class="hideAbleTr">
                        ...
                        <th  class="hidePWSPBILLAMT" style="display:none;" onclick="openSubR('`+ Data[i].COD + `')">` + valuetoFixed(BAmt) + `</th>
                        <th  class="hidePWSPFINALAMT" onclick="openSubR('`+ Data[i].COD + `')">` + valuetoFixed(FAmt) + `</th>
    ...
    tr += `
                  ...
                  <th  class="hidePWSPPARTYNAME">`+ valuetoFixed(grandTotalBAmt) + `</th>
                  <th  class="hidePWSPFINALAMT">`+ valuetoFixed(grandTotalFAmt) + `</th>
