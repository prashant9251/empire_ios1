  ...
  if (SupplierList.length > 0) {
    for (let i = 0; i < SupplierList.length; i++) {
      ...
      var trRow = `<tr class="trPartyHead">
                        <th colspan="17" class="trPartyHead">` + label + `<a href="tel:` + MO + `"><button>MO:` + getValueNotDefine(MO) + `</button></a></th>
                      </tr>
                      `;
      ...
      for (let m = 0; m < customerList.length; m++) {
        ...
        trRow += `
         <tr >
          <th colspan="16"class="hideCUSTOMER_NAME" style="font-weight:bolder;font-size:20px;background-color:#f3f3f3;color:#c107a2;text-align:left;" onclick="openSubR('`+ customer.COD + `','` + ccd.ccd + `')">` + suplabel + `<a href="tel:` + supMO + `"></th>
          </tr>
          ...
          trRow += ` 
                   <tr  class="hideAbleTr" align="center"style="">
                    <td  class="selectBoxReport" style="display:none;">
                      <input type="checkbox" checked id="selectField_`+ ID + `" CNO="` + element.CNO + `"DTYPE="` + element.TYPE + `"VNO="` + element.VNO + `"/>
                      </td>
                   ...
                   <td onclick="openSubR('','` + ccd.ccd + `')">` + formatDate(element.DTE) + `</td>
                                  ...
                                  <td class="hideRMK" style="display:none;"onclick="openSubR('','` + ccd.ccd + `')">` + getValueNotDefine(element.R) + ` </td>
