        ...
        for (let j = 0; j < productPartyList.length; j++) {
          ...
          for (let k = 0; k < filterData.length; k++) {
            ...
            tr += `<tr class="hideAbleTr" >
                        ...
                        <td class="hideIWPWMTS alignRight"  onclick="openSubR('`+ filterDataArr.code + `')">` + parseFloat(filterDataArr.MTS).toFixed(2) + `</td>
                        <td class="hideIWPWNETMTS alignRight"  onclick="openSubR('`+ filterDataArr.code + `')">` + getValueNotDefineNo(NET_MTS) + `</td>
                        <td class="hideIWPWFOLDLESS alignRight"  onclick="openSubR('`+ filterDataArr.code + `')">` + (parseFloat(LESS_FOLD).toFixed(2)) + `</td>
