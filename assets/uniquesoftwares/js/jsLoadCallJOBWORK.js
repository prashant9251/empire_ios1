  ...
  if (DL > 0) {
    ...
    for (var i = 0; i < DL; i++) {
      ...
      tr += `<tr class="trPartyHead"onclick="trOnClick('` + Data[i].code + `','` + city + `','` + broker + `');">
                          <th colspan="15" class="trPartyHead">` + label + `<a href="tel:` + ccode[0].MO + `"><button> MO:` + getValueNotDefine(ccode[0].MO) + `</button></a>` + `</th>
                        </tr>
        ...
        for (j = 0; j < BLL; j++) {
          ...
          tr += ` 
                                ...
                                <td>` + getValueNotDefine(Data[i].billDetails[j].BLL) + `</td>
                                    ...
                                    <td  class="hideRATE" onclick="openSubR('`+ Data[i].code + `')" class="alignRight">` + getValueNotDefineNo(Data[i].billDetails[j].RT) + `</td>
                                    ...
                                    <td class="hideJOBTYPE" onclick="openSubR('`+ Data[i].code + `')">` + getValueNotDefine(Data[i].billDetails[j].C) + `</td>
                                </tr>`;
