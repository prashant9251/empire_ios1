    ...
    for (var i = 0; i < BrokerNameList.length; i++) {
      ...
      tr += ` 
        ...
        <td class="selectBoxReport" style="display:none;">
          ...
          <th class="hideBWTRASNPORT" style="display:none;">TRASNPORT</th>
          <th class="hideBWLR" style="display:none;">LR</th>
      ...
      if (Data.length > 0) {
        for (var k = 0; k < Data.length; k++) {
          ...
          tr += `
            ...
            <td class="hideBWTRASNPORT" style="display:none;">` + getValueNotDefine(Data[k].TR) + `</td>
            <td class="hideBWLR" style="display:none;">` + getValueNotDefine(Data[k].RR) + `</td>
        ...
        tr += `<tr class="tfootcard"  style="">
                                ...
                                <td class="hideBWTRASNPORT" style="display:none;"></td>
                                <td class="hideBWLR" style="display:none;"></td>
