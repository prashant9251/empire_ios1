...
function loadCall(data) {
    Data = data;
    if (entryType != null && entryType != "" && entryType != undefined) {
        Data = Data.filter(function (d) {
            return d.entryType == entryType;
        })
    }
    ...
    if (broker != null && broker != "" && broker != undefined) {
        Data = Data.filter(function (d) {
            return d.broker == broker;
        })
    }
    if (haste != null && haste != "" && haste != undefined) {
        Data = Data.filter(function (d) {
            return d.haste == haste;
        })
    }
    ...
    if (Data.length > 0) {
        ...
        for (var i = 0; i < Data.length; i++) {
            ...
            if (billdetails.length > 0) {
                ...
                <td></td>
                <td colspan="1"><img src="whatsappIcon.png"  width="40" height="40" onclick="makepdf('`+ Data[i].OrderID + `', '` + Data[i].OrderID + `','share');"</img></td>
