...
function loadBillPdfCall() {
  ...
  <div class="page">
    <div class=""style="height:50%;">
        ...
        <div style="width:100%;">
              <div style="text-align: left;float: left;width: 60%;font-size:14px;">
              L.R.NO: `+ getValueNotDefine(MILL[i].billDetails[j].DSG)+ `</div>
              <div style="text-align: left;float: right;width: 40%;font-size:14px">
              PURCHASE PARTY :`+ getValueNotDefine(MILL[i].billDetails[j].WVR) + `
              </div>
        </div>

        <hr class="pdfhr">  
        <div style="width:100%;">
              <div style="text-align: left;float: left;width: 60%;font-size:14px;" id="billNoChallan"></div>
              <div style="text-align: left;float: right;width: 40%;font-size:14px" id="purchaseNo"></div>
        </div>
        ...
        <hr class="pdfhr">  
         ...
         <div>
              <div style="width:100%" class="halfBold">
               ...
               PUR.CHA.NO:`+ getValueNotDefine(MILL[i].billDetails[j].W) + `
                </div>
              </div>
        ...
        <div style="width:100%;">
          ...
          div += challanTakaDetailsInChallan(MILL[i].billDetails[j].CRD);
          ...
          <hr class="pdfhr"> 
            <div style="width:100%" class="halfBold">
              ...
              TOTAL MTS : `+ getValueNotDefine(parseFloat(MILL[i].billDetails[j].WMTS).toFixed(2)) + `
              </div>            
            </div><br>
      ...
      $('#billNoChallan').html("PUR. BILL"+billNoChallan);
      $('#purchaseNo').html("PUR. VNO"+purchaseNo);
