...
class OfficeRecentCalls extends StatelessWidget {
  var UserObj;

  OfficeRecentCalls({Key? key, required this.UserObj}) : super(key: key);
    ...
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
          stream: fireBCollection
              ...
              .where("tktStatus", isEqualTo: "close")
              .orderBy("resolveDate", descending: true)
              .limit(100)
              .snapshots(),
            ...
            return Column(
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      Flexible(child: Chip(label: Text("Recent Close Calls"))),
                      Flexible(
