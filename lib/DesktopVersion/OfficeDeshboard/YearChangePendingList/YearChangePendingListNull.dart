...
class YearChangePendingListDone extends StatelessWidget {
  var UserObj;

  var reqType;

  YearChangePendingListDone({Key? key, required this.UserObj}) : super(key: key);
        ...
        return Container(
          ...
          child: StreamBuilder<QuerySnapshot>(
              stream: fireBCollection
                  ...
                  .where("currentYear", arrayContainsAny: ["25-26"]).snapshots(),
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    Row(
                      children: [
                        Flexible(child: Chip(label: Text("Year Change Done List"))),
                        Flexible(
