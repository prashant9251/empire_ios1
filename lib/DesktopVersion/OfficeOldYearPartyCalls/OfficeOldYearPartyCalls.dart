...
class OfficeOldYearPartyCalls extends StatelessWidget {
  var UserObj;

  OfficeOldYearPartyCalls({Key? key, required this.UserObj}) : super(key: key);
            ...
            return Column(
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      Flexible(child: Chip(label: Text("OLD YEAR PARTY"))),
                      Flexible(
