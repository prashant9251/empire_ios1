...
class AgEmpOrderAcGroup extends StatefulWidget {
  String? AppBartitle = "";
  AgEmpOrderAcGroup({Key? key, this.AppBartitle = "Ac Group"}) : super(key: key);

  @override
  State<AgEmpOrderAcGroup> createState() => _AgEmpOrderAcGroupState();
}

class _AgEmpOrderAcGroupState extends State<AgEmpOrderAcGroup> {
  ...
  late AgEmpOrderAcGroupCubit cubit;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();

    cubit = BlocProvider.of<AgEmpOrderAcGroupCubit>(context);
    getData().then((value) {
      cubit.getData();
      ...
      return Scaffold(
        ...
        body: Center(
          child: Container(
            ...
            child: Column(
              children: [
                BlocBuilder<AgEmpOrderAcGroupCubit, AgEmpOrderAcGroupCubitState>(
                  builder: (context, state) {
                    if (state is AgEmpOrderAcGroupCubitStateLoadPraty) {
