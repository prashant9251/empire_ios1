...
import 'cubit/AgEmpOrderListCubit.dart';

class AgEmpOrderList extends StatefulWidget {
  const AgEmpOrderList({Key? key}) : super(key: key);

  @override
  State<AgEmpOrderList> createState() => _AgEmpOrderListState();
}

class _AgEmpOrderListState extends State<AgEmpOrderList> {
  late AgEmpOrderListCubit cubit;
  ...
  void initState() {
    ...
    super.initState();
    cubit = BlocProvider.of<AgEmpOrderListCubit>(context);
    getData().then((value) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Empire Ag Order List"),
        actions: [
          IconButton(
              onPressed: () async {
                await Myf.Navi(context, AgEmpOrderForm());
                await SyncLocalFunction.onlyOrderFetch();
              },
              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                    child: ListView(
                      children: [
                        BlocBuilder<AgEmpOrderListCubit, AgEmpOrderListState>(
                          builder: (context, state) {
                            if (state is AgEmpOrderListStateLoadOrder) {
