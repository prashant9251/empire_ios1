...
abstract class CrmOutstandingFollowupState {}

class CrmOutstandingFollowupStateIni extends CrmOutstandingFollowupState {}

class CrmOutstandingFollowupStateLoadWidget extends CrmOutstandingFollowupState {
  Widget widget;
  CrmOutstandingFollowupStateLoadWidget(this.widget);
}

class CrmOutstandingFollowupStateLoadLengthParty extends CrmOutstandingFollowupState {}

class CrmOutstandingFollowupStateSelectDays extends CrmOutstandingFollowupState {
